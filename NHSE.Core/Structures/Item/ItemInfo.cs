...
namespace NHSE.Core
{
    ...
    public static class ItemInfo
    {
        ...
        private static readonly Dictionary<ItemKind, ushort> MaxCountByKind = new()
        {
            ...
            {Kind_StickLightColorful, 00001},
            {Kind_Uchiwa, 00001},
            {Kind_SubToolSensu, 00001},
            {Kind_Windmill, 00001},
            ...
            {Kind_Candyfloss, 00001},
            {Kind_SubToolDonut, 00001},
            {Kind_SubToolEat, 00001},
            {Kind_SubToolEatRemakeable, 00001},
            {Kind_Tapioca, 00001},
            {Kind_SubToolCan, 00001},
            {Kind_Icecandy, 00001},
            {Kind_SubToolIcecream, 00001},
            {Kind_SubToolIcesoft, 00001},
            {Kind_SubToolEatDrop, 00001},
            {Kind_SubToolGeneric, 00001},
            {Kind_Basket, 00001},
            {Kind_Lantern, 00001},
            {Kind_SubToolRemakeable, 00001},
            {Kind_Timer, 00001},
            {Kind_Gyroid, 00001},
            {Kind_GyroidScrap, 00001},
            ...
            {Kind_Vine, 00030},
            {Kind_SettingLadder, 00001},
            {Kind_SincerityTowel, 00001},
            {Kind_SouvenirChocolate, 00010},
            {Kind_Giftbox, 00001},
            ...
            {Kind_CommonFabricRug, 00001},
            {Kind_CommonFabricObject, 00001},
            {Kind_CommonFabricTexture, 00001},
            {Kind_OneRoomBox, 00001},
            ...
            {Kind_ShopTorso, 00001},
            {Kind_DummyWrappingOtoshidama, 00001},
            {Kind_GardenEditList, 00001},
        };
